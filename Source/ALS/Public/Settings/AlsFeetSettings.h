...
struct ALS_API FAlsFeetSettings
{
	...
	/// Maximum angle by which the foot lock location can differ from the thigh bone axis. This
	/// is used to prevent the legs from twisting into a spiral when the actor rotates quickly.
