...
public:
	...
	UFUNCTION(BlueprintPure, Category = "ALS|Math Utility", Meta = (AutoCreateRefTerm = "Current, Target", ReturnDisplayName = "Vector"))
	...
	UFUNCTION(BlueprintPure, Category = "ALS|Math Utility|Vector", Meta = (AutoCreateRefTerm = "Vector", ReturnDisplayName = "Vector"))
	static FVector ClampMagnitude01(const FVector& Vector);

	static FVector3f ClampMagnitude01(const FVector3f& Vector);

	UFUNCTION(BlueprintPure, Category = "ALS|Math Utility|Vector", DisplayName = "Clamp Magnitude 01 2D",
		Meta = (AutoCreateRefTerm = "Vector", ReturnDisplayName = "Vector"))
	static FVector2D ClampMagnitude012D(const FVector2D& Vector);

	UFUNCTION(BlueprintPure, Category = "ALS|Math Utility|Vector", Meta = (ReturnDisplayName = "Direction"))
	...
	UFUNCTION(BlueprintPure, Category = "ALS|Math Utility|Vector", Meta = (AutoCreateRefTerm = "Direction", ReturnDisplayName = "Angle"))
	...
	UFUNCTION(BlueprintPure, Category = "ALS|Math Utility|Vector", DisplayName = "Angle Between (Skip Normalization)",
